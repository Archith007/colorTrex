...
function preload(){
  trex_running =   loadAnimation("download (20).png","download (21).png");
  trex_collided = loadAnimation("download (22).png");
  
  groundImage = loadImage("ground2.png");
  
  cloudImage = loadImage("cloud.png");
  
  obstacle1 = loadImage("download (24).png");
  obstacle2 = loadImage("download (25).png");
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.y = height - Math.round(random(80,120));
